The requester does not want Slack cluttered with agent internals such as skill reads, file searches, edit logs, subagent scratch work, or routine tool progress. They want Hermes to package work for subagents and keep the visible thread to user questions, decisions, blockers, approvals, and outcomes.
